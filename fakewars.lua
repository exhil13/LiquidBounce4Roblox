		...
		if callback then
			...
			game.Workspace.Gravity = 0
				...
				if workspace[game.Players.LocalPlayer.Name]:FindFirstChild("wood_sword") then
					...
					game:GetService("ReplicatedStorage").RemoteEvent:FireServer(unpack(args))
					wait(0.1)
					game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame * CFrame.new(nil, 75, nil)
				end
			end
		else
			_G.Tpaura = false
...
--thank you dawn for giving me your skidded cape lmao

local Cape = windowapi.CreateButton({
    ["Name"] = "Cape",
    ["Tab"] = "Visuals",
    ["Function"] = function(callback)
        if callback then
...
local CrasherIron = windowapi.CreateButton({
	["Name"] = "Crasher | Iron",
	["Tab"] = "Utility",
	["Function"] = function(callback)
		if callback then
...
local CrasherBlue = windowapi.CreateButton({
	["Name"] = "Crasher | Blue Wool",
	["Tab"] = "Utility",
	["Function"] = function(callback)
		if callback then
			for i = 1,1000 do
...
local CrasherRed = windowapi.CreateButton({
	["Name"] = "Crasher | Red Wool",
	["Tab"] = "Utility",
	["Function"] = function(callback)
		if callback then
			for i = 1,1000 do
...
local CrasherGreen = windowapi.CreateButton({
	["Name"] = "Crasher | Green Wool",
	["Tab"] = "Utility",
	["Function"] = function(callback)
		if callback then
			for i = 1,1000 do
...
local CrasherYellow = windowapi.CreateButton({
	["Name"] = "Crasher | Yellow Wool",
	["Tab"] = "Utility",
	["Function"] = function(callback)
		if callback then
			for i = 1,1000 do
...
CameraIg = nil
local CameraIg = windowapi.CreateButton({
    ["Name"] = "CameraIg",
    ["Tab"] = "Utility",
    ["Function"] = function(callback)
        if callback then
            CameraIg = true
                ...
                e.CFrame = pos + Vector3.new(0,2,0)
                cam.CameraSubject = e
                e.Transparency = 1
                e.Anchored = true
                game:GetService("ReplicatedStorage").RemoteEvent:FireServer(unpack(args))
                game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = pos
                cam.CameraSubject = lplr.Character.Head
                e:Destroy()
        else
            CameraIg = false
        end
